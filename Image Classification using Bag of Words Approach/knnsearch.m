...
function d=histogram_intersection(a,b)
 ...
 % -------------- code by NISHANT GAUTAM(210832761) --------------- 
  ...
  a = do_normalize(a);   % normalize histogram 'a' values.
  b = do_normalize(b);   % normalize histogram 'b' values.
  
  hist_int = sum(min(a,b));  % computing minimum values.
                             % producing summation of all minium values.
                             
  d = 1 - hist_int;       % computing histogram intersection.
